...
public struct Styles {
    public static let barChartCustomStyle = ChartStyle(
        ...
        accentColor: .cyan,
        gradientColor: GradientColor(start: Color(red: 0.7, green: 1.0, blue: 0.9), end: Color(red: 1.0, green: 1.0, blue: 0.8)),
        textColor: Color.black,
        legendTextColor: Color.gray,
        dropShadowColor: Color.gray)
//    Color(red: 1.0, green: 0.8, blue: 0.8) (a soft pink).
//    Bottom Color: Color(red: 0.9, green: 0.8, blue: 1.0)
    public static let barChartCustomStylePink = ChartStyle(
        backgroundColor: .white,
        accentColor: .cyan,
        gradientColor: GradientColor(start: Color(red: 0.9, green: 0.8, blue: 1.0), end: Color(red: 1.0, green: 0.8, blue: 0.8)),
        textColor: Color.black,
        legendTextColor: Color.gray,
        dropShadowColor: Color.gray)
    
    public static let pieChartCustomStyle = ChartStyle(
        backgroundColor: Color.white,
        accentColor: Colors.DarkPurple,
        secondGradientColor: Colors.BorderBlue,
        textColor: Color.black,
        legendTextColor: Color.gray,
        dropShadowColor: Color.gray)
...
public class TestData{
    ...
    static public var scans:ChartData = ChartData(values: [("Excellent",3220),
                                                            ("Average",1550),
                                                            ("Bad",1203)])
